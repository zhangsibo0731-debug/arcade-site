(function (global) {
  ...
  const DEFINITIONS = Object.freeze([
    ...
    { id: 'colorBurst', name: '彩色爆破', school: '消除', rarity: 'rare', effects: ['7 颗同消触发爆破', '6 颗同消触发爆破', '5 颗同消触发爆破'] },
  ...
  global.PuyoRogueliteRules = Object.freeze({ VERSION, MAX_LEVEL, DEFINITIONS, BY_ID, normalize, choicesFor, offer, choose, cardFor });
})(window);
