(function (global) {
  ...
  const COAST_FISH = [
    ...
    { id: 'reef-octopus', name: '礁岩章鱼', rarity: '稀有', color: '#d97850', min: 520, max: 3600, behavior: 'dash', difficulty: 1.06, weight: 2.8, sprite: 5, spriteX: 33.33, spriteY: 100, spriteSize: SPRITE_SIZE, sheet: SHEET, times: ['night'], weathers: ['rain'], habitat: '潮汐湾 · 雨夜', hint: '会突然缩进礁缝，再向相反方向冲刺。' },
    { id: 'bluefin-tuna', name: '蓝鳍金枪鱼', rarity: '稀有', color: '#4c82a9', min: 3200, max: 16800, behavior: 'dash', difficulty: 1.1, weight: 1.6, sprite: 6, spriteX: 66.67, spriteY: 100, spriteSize: SPRITE_SIZE, sheet: SHEET, times: ['day','dusk'], weathers: ['rain'], habitat: '潮汐湾 · 雨天远投', hint: '高速掠过外湾，第一下拉扯尤其猛烈。' },
