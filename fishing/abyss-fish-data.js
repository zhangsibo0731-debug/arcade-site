(function (global) {
  ...
  const ABYSS_FISH = [
    ...
    { id: 'hatchetfish', name: '银斧鱼', rarity: '常见', color: '#a9d4e5', min: 90, max: 420, behavior: 'active', difficulty: .91, weight: 20, sprite: 1, spriteX: 33.33, spriteY: 0, spriteSize: SPRITE_SIZE, sheet: SHEET, times: ['day','dusk','night'], weathers: ['clear','rain'], habitat: '星渊 · 全天', hint: '薄而闪亮的身体像一枚沉入海底的银币。' },
    { id: 'fangtooth', name: '尖牙鱼', rarity: '常见', color: '#7c604e', min: 240, max: 980, behavior: 'active', difficulty: .96, weight: 15, sprite: 2, spriteX: 66.67, spriteY: 0, spriteSize: SPRITE_SIZE, sheet: SHEET, times: ['dusk','night'], weathers: ['clear','rain'], habitat: '星渊 · 黄昏/夜晚', hint: '牙齿看起来吓人，游动却有自己的固定节奏。' },
    ...
    { id: 'viperfish', name: '幽光蝰鱼', rarity: '稀有', color: '#6346b8', min: 520, max: 2400, behavior: 'dash', difficulty: 1.08, weight: 2.5, sprite: 5, spriteX: 33.33, spriteY: 100, spriteSize: SPRITE_SIZE, sheet: SHEET, times: ['dusk','night'], weathers: ['rain'], habitat: '星渊 · 雨天黄昏/夜晚', hint: '先熄灭光芒停顿片刻，再突然冲向另一端。' },
    { id: 'oarfish', name: '皇带鱼', rarity: '稀有', color: '#b8cde1', min: 2800, max: 13800, behavior: 'dash', difficulty: 1.1, weight: 1.4, sprite: 6, spriteX: 66.67, spriteY: 100, spriteSize: SPRITE_SIZE, sheet: SHEET, times: ['dusk','night'], weathers: ['clear'], habitat: '星渊 · 晴朗黄昏/夜晚远投', hint: '银色长躯像一条从海底升起的缎带。' },
