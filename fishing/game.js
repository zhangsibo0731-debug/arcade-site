(function () {
  ...
  const { COAST_EXPANSION_FISH } = window.FishingCoastExpansionFishData;
  const { ABYSS_FISH } = window.FishingAbyssFishData;
  const { ABYSS_EXPANSION_FISH } = window.FishingAbyssExpansionFishData;
  const ALL_FISH = FISH.concat(LAKE_EXPANSION_FISH, RIVER_FISH, RIVER_EXPANSION_FISH, COAST_FISH, COAST_EXPANSION_FISH, ABYSS_FISH, ABYSS_EXPANSION_FISH);
